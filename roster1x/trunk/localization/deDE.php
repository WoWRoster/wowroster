...
$wordings['deDE']['confirm_config_submit'] = 'Dies wird die �nderungen in die Datenbank schreiben. Sind sie sicher?';
$wordings['deDE']['confirm_config_reset'] = 'Dies wird das Formular in den Zustand zur�cksetzen in dem es am Anfang war. Sind sie sicher?';
