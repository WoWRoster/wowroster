...
DROP TABLE IF EXISTS `roster_account`;
...
DROP TABLE IF EXISTS `roster_guild`;
...
DROP TABLE IF EXISTS `roster_pets`;
...
DROP TABLE IF EXISTS `roster_pvp2`;
...
DROP TABLE IF EXISTS `roster_quests`;
...
DROP TABLE IF EXISTS `roster_realmstatus`;
...
DROP TABLE IF EXISTS `roster_recipes`;
...
DROP TABLE IF EXISTS `roster_reputation`;
...
DROP TABLE IF EXISTS `roster_spellbook`;
...
DROP TABLE IF EXISTS `roster_spellbooktree`;
...
DROP TABLE IF EXISTS `roster_talents`;
...
DROP TABLE IF EXISTS `roster_talenttree`;
