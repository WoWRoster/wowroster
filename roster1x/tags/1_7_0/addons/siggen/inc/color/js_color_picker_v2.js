	...
	************************************************************************************************************/
	...
	var form_widget_amount_slider_handle = 'addons/siggen/inc/color/images/slider_handle.gif';
		...
		do{
			if(subDiv.tagName=='DIV' && subDiv.className!='colorPickerCloseButton'){
				if(subDiv==thisObj){
					...
					img.src = "addons/siggen/inc/color/images/tab_right_active.gif";
					...
					img.src = "addons/siggen/inc/color/images/tab_right_inactive.gif";
					if(activeColorDiv)
	...
	function createColorPickerTopRow(inputObj){
		...
		for(var no=0;no<tabs.length;no++){
			...
			tabImg.src = "addons/siggen/inc/color/images/tab_right_" + suffix + ".gif";
	...
	function toggleCloseButton()
	{
		...
		this.style.backgroundColor = '#CBA300';
	}
