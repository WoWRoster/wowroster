...
{
	die_quietly('Character was not specified','Character Error');
}
...
if( is_numeric($name) )
{
	...
	if( !is_object($char) )
		die_quietly('Sorry no character data for member_id &quot;'.$name.'&quot;','Character Not Found');
...
else
{
	...
	if( !is_object($char) )
		die_quietly('Sorry no character data for &quot;'.$name.'&quot; of &quot;'.$server.'&quot;','Character Not Found');
}
