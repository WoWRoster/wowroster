...
class memberslist
{
	...
	function install()
	{
		...
		$installer->add_config("1060,'spec_icon','1','radio{On^1|Off^0','display'");
		$installer->add_config("1070,'class_icon','1','radio{On^1|Off^0','display'");
		$installer->add_config("1080,'class_color','1','radio{On^1|Off^0','display'");
