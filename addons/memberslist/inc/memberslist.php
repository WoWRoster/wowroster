	...
	*********************************************************************/
	...
	function last_online_value ( $row )
	{
		...
		if ( $row['last_online'] != '')
		{
			...
			$realtime = '<div style="display:none;">' . $row['last_online'] . '</div>';

			if( isset($row['online']) && $row['online'] == '1' || $difference < 0 )
			{
				return $realtime . $roster->locale->act['online_at_up'];
			}

			if($difference < 60)
			{
				return $realtime . $difference.' second'.($difference == '1' ? '' : 's').' ago';
			}
			else
			{
				...
				if($difference < 60)
				{
					return $realtime . $difference.' minute'.($difference == '1' ? '' : 's').' ago';
				}
				else
				{
					$difference = round($difference / 60);
					if($difference < 24)
					{
						return $realtime . $difference.' hour'.($difference == '1' ? '' : 's').' ago';
					}
					else
					{
						...
						if($difference < 7)
						{
							return $realtime . $difference.' day'.($difference == '1' ? '' : 's').' ago';
						}
						else
						{
							...
							if( $difference < 4 )
							{
								return $realtime . $difference.' week'.($difference == '1' ? '' : 's').' ago';
							}
							else
							{
								...
								if( $difference < 12 )
								{
									return $realtime . $difference.' month'.($difference == '1' ? '' : 's').' ago';
								}
								else
								{
									$difference = round($difference / 12);
									return $realtime . $difference.' year'.($difference == '1' ? '' : 's').' ago';
								}
