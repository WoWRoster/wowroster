...
<?php print border('sgray','start','Main Settings'); ?>
  <table class="sc_table" cellspacing="0" cellpadding="2">
    ...
    <tr>
      <td class="sc_row<?php echo (((++$row)%2)+1); ?>" align="left"><?php print $functions->createTip( 'Must be a directory in &quot;'.str_replace('\\','/',$sigconfig_dir).'&quot;','Images directory' ); ?></td>
...
?>
  <table class="sc_table" cellspacing="0" cellpadding="2">
    ...
    <tr>
      <td class="sc_row<?php echo (((++$row)%2)+1); ?>" align="left"><?php print $functions->createTip( 'Specify a directory to save generated images to<br />Realative to &quot;'.BASEDIR.'&quot;','Saved images directory' ); ?></td>
