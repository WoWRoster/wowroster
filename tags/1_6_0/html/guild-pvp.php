<?php
$versions['versionDate']['guildpvp'] = '$Date: 2005/12/30 20:40:52 $'; 
$versions['versionRev']['guildpvp'] = '$Revision: 1.8 $'; 
$versions['versionAuthor']['guildpvp'] = '$Author: mordon $';
...
function borderTop($col)
{
	if ($col < 2)
		$col = 2;
	print '  <tr>
    <th colspan="'.$col.'" class="rankbordertop"><span class="rankbordertopleft"></span>
...
function tableHeaderRow($th)
{
	...
	foreach ($th as $header)
	{
		++$acount;
		if ($acount == 1)
			print "  <tr>\n    <th class=\"rankbordercenterleft\"><div class=\"membersHeader\">$header</div></th>\n";
...
function borderBottom($col)
{
	if ($col < 2)
		$col = 2;
	print '  <tr>
    <th colspan="'.$col.'" class="rankborderbot"><span class="rankborderbotleft"></span>
