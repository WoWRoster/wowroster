<?php
$versions['versionDate']['membersHonor'] = '$Date: 2005/12/30 21:09:21 $'; 
$versions['versionRev']['membersHonor'] = '$Revision: 1.7 $'; 
$versions['versionAuthor']['membersHonor'] = '$Author: mordon $';
...
switch ($switchString)
{
	...
	case 'lifetimeRankName':
		$query .= ' ORDER BY players.lifetimeHighestRank DESC, members.name ASC';
	break; 
	default: 
		$query .= ' ORDER BY members.level DESC, members.name ASC'; 
}
...
$borderTop = '  <tr>
    <th colspan="15" class="rankbordertop"><span class="rankbordertopleft"></span><span class="rankbordertopright"></span></th>
  </tr>'."\n";                 
$tableHeaderRow = '  <tr> 
...
$borderBottom = '  <tr>
    <th colspan="15" class="rankborderbot"><span class="rankborderbotleft"></span>
