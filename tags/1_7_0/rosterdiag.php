...
// Initialize the $allow_login var to prevent hijacking
$allow_login = 0;
...
{
	print('<span class="title_text">Roster Diag</span><br />'.$password_message);
}
else
{
	print('<span class="title_text">Roster Diag</span><br />'.$password_message.$passbox);
}
