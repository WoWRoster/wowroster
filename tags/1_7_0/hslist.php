...
'.border('sgray','start',"<div style=\"cursor:pointer;width:350px;\" onclick=\"swapShow('HSLIST_col','HSLIST_full')\"><img src=\"".$roster_conf['img_url']."plus.gif\" style=\"float:right;\" />".$roster_conf['guild_name'].$wordings[$roster_conf['roster_lang']]['hslist'].'</div>').'
'.border('sgray','end').'
</div>
<div id="HSLIST_full"'.$pvp_hs_full.'>
'.border('sgray','start',"<div style=\"cursor:pointer;width:350px;\" onclick=\"swapShow('HSLIST_col','HSLIST_full')\"><img src=\"".$roster_conf['img_url']."minus.gif\" style=\"float:right;\" />".$roster_conf['guild_name'].$wordings[$roster_conf['roster_lang']]['hslist'].'</div>').'
