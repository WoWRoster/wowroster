...
if( !isset($_POST['search']) && !isset($_GET['search']) )
{
        ...
        echo  '<br /><form id="search" name="search" action="" method="post" enctype="multipart/form-data" >'
                ...
                . '<input type="submit" value="' . $roster->locale->act['search'] . '" onclick="loadXMLDoc( "' . makelink() . '", "' . makelink() . '", function( req ){ loadAjaxInDiv( req, "search_result_display" ); } )"/><br />'
                . '<br />';
        ...
        $item_adv_options .= '<label for="item_minle">Level:<input type="text" name="item_minle" id="item_minle" size="3" maxlength="3"/></label> - <label for="item_maxle"><input type="text" name="item_maxle" id="item_maxle" size="3" maxlength="3"  /></label><br />';
	$item_adv_options .= '<label for="item_quality">Quality:<br />
