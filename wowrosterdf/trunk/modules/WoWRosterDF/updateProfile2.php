...
$inputForm = "
                <form action=\"index.php?name=$module_name&amp;file=updateProfile\" enctype=\"multipart/form-data\" method=\"POST\" onsubmit=\"submitonce(this)\">
$authFields
...
if( $htmlout )
{
	...
	if( $uploadFound )
	{
		...
		if( !empty($errorstringout) )
		{
			...
			print "<br />\n";
			print '<form method="post" action="index.php?name='.$module_name.'&amp;file=updateProfile" name="post">'."\n";
