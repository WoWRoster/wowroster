...
'.border('sgray','start',"<div style=\"cursor:pointer;width:350px;\" onclick=\"swapShow('HSLIST_col','HSLIST_full')\"><img src=\"".$roster_conf['img_url']."plus.gif\" style=\"float:right;\" alt=\"\" />".$roster_conf['guild_name'].$wordings[$roster_conf['roster_lang']]['hslist'].'</div>').'
'.border('sgray','end').'
</div>
...
if ($row) {
	...
	print('<a href="'.getlink('&amp;file=indexhonor&amp;s=RankName').'">'.$wordings[$roster_conf['roster_lang']]['hslist1'].'</a></td>'."\n");
...
if ($row)
{
	...
	++$striping_counter;
	rankLeft((($striping_counter % 2) +1));
	print('<a href="'.getlink('&amp;file=indexhonor&amp;s=lastweekRank').'">'.$wordings[$roster_conf['roster_lang']]['hslist2'].'</a></td>'."\n");
	rankMid((($striping_counter % 2) +1));
	print($row['name']);
	print("</td>\n");
	rankRight((($striping_counter % 2) +1));
...
if ($row) {
	...
	++$striping_counter;
	rankLeft((($striping_counter % 2) +1));
	print('<a href="'.getlink('&amp;file=indexhonor&amp;s=lastweekHK').'">'.$wordings[$roster_conf['roster_lang']]['hslist3'].'</a></td>'."\n");
	rankMid((($striping_counter % 2) +1));
	print($row['name']);
	print("</td>\n");
	rankRight((($striping_counter % 2) +1));
...
if ($row) {
	...
	++$striping_counter;
	rankLeft((($striping_counter % 2) +1));
	print('<a href="'.getlink('&amp;file=indexhonor&amp;s=lastweekDK').'">'.$wordings[$roster_conf['roster_lang']]['hslist4'].'</a></td>'."\n");
	rankMid((($striping_counter % 2) +1));
	print($row['name']);
	print("</td>\n");
	rankRight((($striping_counter % 2) +1));
...
if ($row) {
	...
	++$striping_counter;
	rankLeft((($striping_counter % 2) +1));
	print('<a href="'.getlink('&amp;file=indexhonor&amp;s=lastweekContribution').'">'.$wordings[$roster_conf['roster_lang']]['hslist5'].'</a></td>'."\n");
	rankMid((($striping_counter % 2) +1));
	print($row['name']);
	print("</td>\n");
	rankRight((($striping_counter % 2) +1));
...
if ($row) {
	...
	++$striping_counter;
	rankLeft((($striping_counter % 2) +1));
	print('<a href="'.getlink('&amp;file=indexhonor&amp;s=lifetimeRankName').'">'.$wordings[$roster_conf['roster_lang']]['hslist6'].'</a></td>'."\n");
	rankMid((($striping_counter % 2) +1));
	print($row['name']);
	print("</td>\n");
	rankRight((($striping_counter % 2) +1));
...
if ($row) {
	...
	++$striping_counter;
	rankLeft((($striping_counter % 2) +1));
	print('<a href="'.getlink('&amp;file=indexhonor&amp;s=lifetimeHK').'">'.$wordings[$roster_conf['roster_lang']]['hslist7'].'</a></td>'."\n");
	rankMid((($striping_counter % 2) +1));
	print($row['name']);
	print("</td>\n");
	rankRight((($striping_counter % 2) +1));
...
if ($row) {
	...
	++$striping_counter;
	rankLeft((($striping_counter % 2) +1));
	print('<a href="'.getlink('&amp;file=indexhonor&amp;s=lifetimeDK').'">'.$wordings[$roster_conf['roster_lang']]['hslist8'].'</a></td>'."\n");
	rankMid((($striping_counter % 2) +1));
	print($row['name']);
	print("</td>\n");
	rankRight((($striping_counter % 2) +1));
...
if ($row) {
	...
	++$striping_counter;
	rankLeft((($striping_counter % 2) +1));
	print('<a href="'.getlink('&amp;file=indexhonor').'">'.$wordings[$roster_conf['roster_lang']]['hslist9'].'</a></td>'."\n");
	rankMid((($striping_counter % 2) +1));
	print($row['name']);
	print("</td>\n");
	rankRight((($striping_counter % 2) +1));
