...
if( $roster_conf['menu_pvp_page'] && $roster_conf['pvp_log_allow'] )
	print '        <li><a href="'.getlink('&amp;file=indexpvp').'">'.$wordings[$roster_conf['roster_lang']]['pvplist'].'</a></li>'."\n";
...
if( $roster_conf['menu_tradeskills_page'] )
	print '        <li><a href="'.getlink('&amp;file=tradeskills').'">'.$wordings[$roster_conf['roster_lang']]['professions'].'</a></li>'."\n";
?>
     </ul></td>
<!-- Links Column 3 -->
...
if( $roster_conf['menu_search_page'] )
	print '        <li><a href="'.getlink('&amp;file=indexsearch').'">'.$wordings[$roster_conf['roster_lang']]['search'].'</a></li>'."\n";

if( is_admin() )
	print '        <li><a href="'.adminlink($module_name.'&amp;file=index').'">'.$wordings[$roster_conf['roster_lang']]['roster_config'].'</a></li>'."\n";
?>
        <li><a href="<?php print getlink('&amp;file=credits'); ?>"><?php print $wordings[$roster_conf['roster_lang']]['credit']; ?></a></li>
      </ul></td>
<?php
if( $roster_conf['menu_right_pane'] && $guild_data_rows > 0 )
{
	...
	{
		print '<img alt="WoW Server Status" src="'.getlink('&amp;file=realmstatus').'" /></td>';
	}
