...
if (isset($_REQUEST['calculate']))
{
	...
	$detailList .= "  <tr>"."\n";
	$detailList .= '    <td class="membersHeader">'.$wordings[$roster_conf['roster_lang']]['writname'].":</td>"."\n";
	$detailList .= '    <td class="membersHeader">'.$wordings[$roster_conf['roster_lang']]['writs'].":</td>"."\n";
	$detailList .= '    <td class="membersHeader">'.$wordings[$roster_conf['roster_lang']]['qty'].":</td>"."\n";
	$detailList .= '    <td class="membersHeader">'.$wordings[$roster_conf['roster_lang']]['reagents'].'</td>'."\n";
	$detailList .= '    <td class="membersHeader" width="70">'.$wordings[$roster_conf['roster_lang']]['whocanmakeit'].'</td>'."\n";
	$detailList .= '    <td class="membersHeader">'.$wordings[$roster_conf['roster_lang']]['rawmats'].'</td>'."\n";
	$detailList .= '  </tr>'."\n";
	$rc = 0;
	...
	$summaryList .= "  <tr>"."\n";
	$summaryList .= '    <td class="membersHeader">'.$wordings[$roster_conf['roster_lang']]['Reagents']."</td>"."\n";
	$summaryList .= '    <td class="membersHeader">'.$wordings[$roster_conf['roster_lang']]['Total']."</td>"."\n";
	$summaryList .= '  </tr>'."\n";
...
else
{
	...
	$content .= "  <tr>"."\n";
	$content .= '    <td class="membersHeader">'.$wordings[$roster_conf['roster_lang']]['calc'].' '.$wordings[$roster_conf['roster_lang']]['qty'].":</td>"."\n";
	$content .= '    <td class="membersHeader">'.$wordings[$roster_conf['roster_lang']]['writname'].":</td>"."\n";
	$content .= '    <td class="membersHeader">'.$wordings[$roster_conf['roster_lang']]['qty'].":</td>"."\n";
