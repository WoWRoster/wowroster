...
$wordings['enUS']['nodata']="Could not find guild: <b>'".$roster_conf['guild_name']."'</b> for server <b>'".$roster_conf['server_name']."'</b><br />You need to <a href=\"".getlink('&amp;file=update')."\">load your guild</a> first and make sure you <a href=\"".adminlink($module_name.'&amp;file=index')."\">finished configuration</a><br /><br /><a href=\"http://www.wowroster.net/wiki\" target=\"_blank\">Click here for installation instructions</a>";

$wordings['enUS']['update_page']='Update (update.php)';
$wordings['enUS']['updCharInfo']='Update Character Info';
...
<ul>
<li>Use <a href="'.$roster_conf['uploadapp'].'" target="_blank">UniUploader</a></li>
...
<li>Go to <a href="'.getlink('&amp;file=update').'">the update page</a></li>
