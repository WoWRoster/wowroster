...
{
  echo '<script type="text/javascript" src="'.$roster_conf['roster_dir'].'/'.$roster_conf['overlib'].'"></script>';
  echo '<script type="text/javascript" src="'.$roster_conf['roster_dir'].'/'.$roster_conf['overlib_hide'].'"></script>';
  }
  ?>
...
{
	echo '
<div style="text-align:center;margin:10px;" class="wowroster"><a href="'.$roster_conf['website_address'].'">
