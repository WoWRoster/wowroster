...
if ($row)
{
	...
	print('<a href="'.getlink('&amp;file=indexpvp&amp;type=guildwins').'">'.$wordings[$roster_conf['roster_lang']]['pvplist1'].'</a></td>'."\n");
...
if ($row)
{
	...
	++$striping_counter;
	pvprankRight((($striping_counter % 2) +1));
	print('<a href="'.getlink('&amp;file=indexpvp&amp;type=guildlosses').'">'.$wordings[$roster_conf['roster_lang']]['pvplist2'].'</a></td>'."\n");
	pvprankMid((($striping_counter % 2) +1));
	if ($row['guild'] == '') {
		$guildname = '(unguilded)';
	} else {
...
if ($row)
{
	...
	++$striping_counter;
	pvprankRight((($striping_counter % 2) +1));
	print('<a href="'.getlink('&amp;file=indexpvp&amp;type=enemywins').'">'.$wordings[$roster_conf['roster_lang']]['pvplist3'].'</a></td>'."\n");
	pvprankMid((($striping_counter % 2) +1));
	print($row['name']);
	print("</td>\n");
	pvprankLeft((($striping_counter % 2) +1));
...
if ($row)
{
	...
	++$striping_counter;
	pvprankRight((($striping_counter % 2) +1));
	print('<a href="'.getlink('&amp;file=indexpvp&amp;type=enemylosses').'">'.$wordings[$roster_conf['roster_lang']]['pvplist4'].'</a></td>'."\n");
	pvprankMid((($striping_counter % 2) +1));
	print($row['name']);
	print("</td>\n");
	pvprankLeft((($striping_counter % 2) +1));
...
if ($row)
{
	...
	pvprankRight((($striping_counter % 2) +1));
	print('<a href="'.getlink('&amp;file=indexpvp&amp;type=purgewins').'">'.$wordings[$roster_conf['roster_lang']]['pvplist5'].'</a></td>'."\n");
	pvprankMid((($striping_counter % 2) +1));
	print($row['gn']);
	print("</td>\n");
	pvprankLeft((($striping_counter % 2) +1));
...
if ($row)
{
	...
	pvprankRight((($striping_counter % 2) +1));
	print('<a href="'.getlink('&amp;file=indexpvp&amp;type=purgelosses').'">'.$wordings[$roster_conf['roster_lang']]['pvplist6'].'</a></td>'."\n");
	pvprankMid((($striping_counter % 2) +1));
	print($row['gn']);
	print("</td>\n");
	pvprankLeft((($striping_counter % 2) +1));
...
if ($row)
{
	...
	pvprankRight((($striping_counter % 2) +1));
	print('<a href="'.getlink('&amp;file=indexpvp&amp;type=purgeavewins').'">'.$wordings[$roster_conf['roster_lang']]['pvplist7'].'</a></td>'."\n");
	pvprankMid((($striping_counter % 2) +1));
	print($row['gn']);
	print("</td>\n");
	pvprankLeft((($striping_counter % 2) +1));
...
if ($row)
{
	...
	++$striping_counter;
	pvprankRight((($striping_counter % 2) +1));
	print('<a href="'.getlink('&amp;file=indexpvp&amp;type=purgeavelosses').'">'.$wordings[$roster_conf['roster_lang']]['pvplist8'].'</a></td>'."\n");
	pvprankMid((($striping_counter % 2) +1));
	print($row['gn']);
	print("</td>\n");
	pvprankLeft((($striping_counter % 2) +1));
