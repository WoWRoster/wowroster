...
if( !$char )
{
	die_quietly('Sorry no data in database for &quot;'.$_GET['cname'].'&quot; of &quot;'.$_GET['server'].'&quot;<br /><br /><a href="'.getlink().'">'.$wordings[$roster_conf['roster_lang']]['backlink'].'</a>','Character Not Found');
}
...
$url = '<a href="'.getlink('&amp;file=char&amp;cname='.$name.'&amp;server='.$server);
...
echo $menu_cell.'<a href="'.getlink('&amp;file=index').'">'.$wordings[$roster_conf['roster_lang']]['backlink'].'</a></td>'."\n";
