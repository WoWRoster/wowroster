...
<ul>
<li>Benutze den <a href="'.$roster_conf['uploadapp'].'" target="_new">UniUploader</a>&nbsp; '.$index_text_uniloader.'</li>
</ul>
...
$wordings['deDE']['energy']='Energy';
$wordings['deDE']['rage']='Rage';
...
$wordings['deDE']['admin']['website_address'] = "Webseitenadresse|Used for url link for logo, and guildname link in the main menu<br>Some roster addons may also use this";
$wordings['deDE']['admin']['roster_dir'] = "Roster URL|The URL path to the Roster directory<br>It is critical that this is correct or errors may occur<br>(EX: http://www.site.com/roster )<br><br>A full url is not required but a foreward slash before the directory is<br>(EX: /roster )";
$wordings['deDE']['admin']['server_name_comp'] = "char.php Compatibility Mode|If your character page does not work, try changing this";
$wordings['deDE']['admin']['interface_url'] = "Interface Directory URL|Directory that the Interface images are located<br>Default is &quot;img/&quot;<br><br>You can use a relative path or a full URL";
$wordings['deDE']['admin']['img_suffix'] = "Interface Image Extension|The image type of the Interface images";
$wordings['deDE']['admin']['img_url'] = "Roster Images Directory URL|Directory that Roster's images are located<br>Default is &quot;img/&quot;<br><br>You can use a relative path or a full URL";
$wordings['deDE']['admin']['timezone'] = "Timezone|Displayed after timestamps so people know what timezone the time references are in";
$wordings['deDE']['admin']['localtimeoffset'] = "Time Offest|The timezone offset from UTC/GMT<br>Times on roster will be displayed as a calculated value using this offset";
$wordings['deDE']['admin']['pvp_log_allow'] = "Allow upload of PvPLog Data|Changing this to &quot;no&quot; will disable the PvPLog upload field in &quot;update.php&quot;";
$wordings['deDE']['admin']['use_update_triggers'] = "Addon Update Triggers|Addon Update Triggers are for addons that need to run during a character or guild update<br>Some addons my require that this is turned on for them to function properly";
