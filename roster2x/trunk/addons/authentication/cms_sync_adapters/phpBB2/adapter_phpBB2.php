...
class phpBB2 extends CMS_Sync
{
	
	var $cms_users_table    = 'phpbb_users';
	...
	var $cms_new_user_query = 'INSERT INTO phpbb_users (username, user_password, user_email) VALUES (\'%1$s\', \'%2$s\', \'%3$s\')';
