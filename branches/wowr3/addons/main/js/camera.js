...
////////callbacks
	...
	if(elem.length!=0){
		...
		if (loader != 'pie') {
			...
			canvas.setAttribute("style", "position:absolute; z-index:5001; "+piePosition);
			var rad;
			var radNew;
		...
		if($(pagination).length) {
			...
			for (li = 0; li < amountSlide; li++){
				$('.camera_pag_ul',wrap).append('<li class="pag_nav_'+li+'" style="position:relative; z-index:5001"><span><span>'+li+'</span></span></li>');
			}
